...
var DatePicker = function (_PureComponent) {
  ...
  function DatePicker() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = DatePicker.__proto__ || Object.getPrototypeOf(DatePicker)).call.apply(_ref, [this].concat(args))), _this), _this.state = {}, _this.inputRef = _react2.default.createRef(), _this.onClick = function (event) {
